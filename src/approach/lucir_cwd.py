...
class Appr(Inc_Learning_Appr):
    ...
    def __init__(self, model, device, nepochs=160, lr=0.1, decay_mile_stone=[80,120], lr_decay=0.1, clipgrad=10000,
                 ...
                 # aux specifics
                 aux_coef=0.1, reject_threshold=1, first_task_lr=0.1, first_task_bz=128,coef_2i=0.1
                 ):
        ...
        self.aux_loss = DecorrelateLossClass(reject_threshold=self.reject_threshold, ddp=ddp, coef_2i=self.coef_2i)
        # -------------------------------------------------------------
    ...
    def extra_parser(args):
        ...
        parser.add_argument('--coef-2i', default=0.1, type=float, required=False,
                            help='coefficient for inter/intra-loss')
    ...
    def train_epoch(self, t, trn_loader):
        ...
        for images, targets in trn_loader:
            ...
            loss_lucir = self.criterion(t, outputs, targets, ref_outputs, features, ref_features)
